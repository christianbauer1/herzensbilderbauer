...
export default function Banner() {
  ...
  return (
    <div className="relative isolate z-[99999] flex items-center gap-x-6 overflow-hidden bg-gray-50 px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
      <div
      ...
      <p className="animate-pulse text-sm leading-6 text-gray-900">
        Nur für kurze Zeit: Erhalte ein kostenloses Hochzeitsvideo zu deiner
        Fotoreportage{" "}
        <Link
