...
export const metadata = {
  title: "Impressum | Fotograf in Ansbach",
  description:
    "Rechtliche Informationen gemäß den gesetzlichen Anforderungen. Kontaktiert mich für weitere Details.",
...
export default function Impressum() {
  return (
    <div className="mx-auto mb-32 mt-48 flex max-w-4xl flex-col gap-4 px-3">
      ...
      <h2 className="font-bold">Vertreten durch:</h2>
      <p>Christian Bauer</p>
      ...
      <h2 className="font-bold">Datenschutz</h2>
      ...
      <Button asChild variant={"secondary"} className="my-4">
        <Link href={"/datenschutz"}>Mehr Informationen</Link>
      </Button>
